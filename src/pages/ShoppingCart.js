...
export default function ShoppingCart() {
  ...
  const handleQuantityChange = (quantity, itemId) => {
    ...
    const matchedItem = cartItems.find(item => item.itemId === itemId);
    const newData = { id:matchedItem.id , itemId, quantity}
    updateCartItemsMutation.mutate(newData);    
  }
  ...
  const handleDelete = (itemId) => {
    ...
    const matchedItem = cartItems.find(item => item.itemId === itemId);
    deleteCartItemsMutation.mutate(matchedItem.id);
  }
